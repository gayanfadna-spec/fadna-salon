            ...
            {step === 2 && (
                <div className="animate-fade-in" style={{ textAlign: 'center' }}>
                    ...
                    <div className="product-intro" style={{ marginBottom: '2rem', lineHeight: '1.6', color: 'rgba(255,255,255,0.9)' }}>
                        <h3>Satiny</h3>
                        <p>හිසකෙස් වැටීම බොහෝ විට නොදැනිම ආරම්භ වෙයි—දුර්වල වූ මූලයන් සහ හිස්තලයේ එන්සයිම් අසමතුලිතතාවය නිසා හිසකෙස් සිහින්වීම, වියළිවීම සහ දිප්ති අහිමි වීම සිදුවේ.
